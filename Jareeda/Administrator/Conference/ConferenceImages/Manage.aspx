<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPages/AdminMain.master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Administrator.Conference.ConferenceImages.Manage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div class="g12 widgets">
			<div class="widget widget-header-blue" id="widget_charts" data-icon="graph-dark">
				<h3 class="handle">Manage Conference Images</h3>
            ...
            <dx:ASPxGridView ID="ConferenceProgramGrid" runat="server" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataImageColumn FieldName="PhotoPath" VisibleIndex="5">
...
<ValidationSettings AllowedFileExtensions=".jpg,.jpeg,.jpe,.gif,.png">
                    ...
                    <dx:GridViewDataTextColumn Caption="Title" FieldName="PhotoTitle" VisibleIndex="2" Width="160px">
                        <EditFormSettings ColumnSpan="2" Visible="True" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Link" FieldName="PhotoLink" Visible="False" 
                        VisibleIndex="6">
                        <EditFormSettings ColumnSpan="2" Visible="True" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataMemoColumn Caption="Description" FieldName="PhotoDescription" 
