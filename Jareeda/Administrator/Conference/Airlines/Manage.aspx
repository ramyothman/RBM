<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPages/AdminMain.master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Administrator.Conference.Airlines.Manage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="g12 widgets">
			<div class="widget widget-header-blue" id="widget_charts" data-icon="graph-dark">
				<h3 class="handle">Manage AirLine</h3>
				<div class="inner-content">
            <dx:ASPxGridView ID="AirLineGrid" runat="server" AutoGenerateColumns="False" KeyFieldName="ID"
                ...
                <Templates>
                    <DetailRow>
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" 
                            DataSourceID="dsAirLinelanguage" KeyFieldName="ID" OnBeforePerformDataSelect="ASPxGridView1_BeforePerformDataSelect">
                             <Columns>
                    <dx:GridViewCommandColumn ButtonType="Image" VisibleIndex="0" Width="60px" Caption=" ">
                        <DeleteButton Visible="True">
                            <Image Height="16px" Url="~/images/griddelete.png" Width="16px">
                    ...
                    <dx:GridViewDataCheckColumn FieldName="NewRecord" Visible="False" VisibleIndex="2">
                     ...
                     <dx:GridViewDataComboBoxColumn Caption="Language" FieldName="LanguageID" 
                        ...
                        <PropertiesComboBox DataSourceID="dsLanguages" TextField="Name" ValueField="LanguageId"></PropertiesComboBox>
                                ...
                                <dx:GridViewDataTextColumn FieldName="AirLineParentID" VisibleIndex="3" Visible="false">
                                </dx:GridViewDataTextColumn>
                </Columns>
                <SettingsBehavior AllowFocusedRow="True" ConfirmDelete="True" EnableRowHotTrack="True" />
                <SettingsEditing Mode="PopupEditForm" PopupEditFormWidth="450px" />
                ...
                TypeName="BusinessLogicLayer.Components.ContentManagement.LanguageLogic">
                        ...
                        <asp:ObjectDataSource ID="dsAirLinelanguage" runat="server" 
                            DeleteMethod="Delete" InsertMethod="Insert" 
                            OldValuesParameterFormatString="original_{0}" SelectMethod="GetAll" 
                            TypeName="BusinessLogicLayer.Components.Conference.AirLineLanguageLogic" 
                            UpdateMethod="Update">
                            <DeleteParameters>
                            ...
                            <InsertParameters>
                                ...
                                <asp:Parameter Name="LanguageID" Type="Int32" />                                
                                  <asp:SessionParameter Name="AirLineParentID" SessionField="ParentID" Type="Int32" />
                            </InsertParameters>
                            <SelectParameters>
            ...
            <asp:ObjectDataSource ID="DSAirLine" runat="server" DeleteMethod="Delete" InsertMethod="Insert"
                OldValuesParameterFormatString="original_{0}" SelectMethod="GetAll" TypeName="BusinessLogicLayer.Components.Conference.AirLineLogic"
                UpdateMethod="Update">
                <DeleteParameters>
                    <asp:Parameter Name="Original_ID" Type="Int32" />
                </DeleteParameters>
