<%@ Page Title="" Language="C#" MasterPageFile="~/_GeniMaster/RootAdmin.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Administrator.g.PageManager.Builder.Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ToolbarContent" runat="server">
    <div class="col-md-3">
        <div class="title-icon">
            <img runat="server" src="~/_GeniMaster/styles/images/ribbon/webbuilder.png" />
        </div>
        <div class="title-text"><asp:Literal runat="server" Text="<%$Resources:ContentManagement, WBTitle %>"></asp:Literal></div>
    </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Content" runat="server">
 ...
 <dx:aspxpopupcontrol  runat="server" ID="popupSettings" AllowResize="True" AllowDragging="true"  ClientInstanceName="popupSettings" HeaderText="Settings" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Width="500px" DragElement="Window"><ContentCollection>
