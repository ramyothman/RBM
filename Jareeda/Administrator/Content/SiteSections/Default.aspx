<%@ Page Title="" Language="C#" MasterPageFile="~/_Masters/AdminMain.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Administrator.Content.SiteSections.Default" %>
<%@ Register Src="~/Dashboard/Controls/Content/TotalSectionsWidgetItem.ascx" TagName="SectionsTotalControl" TagPrefix="jareeda" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="TitlePlaceHolder" runat="server">
     <div class="col-md-4">
        <h1>
            <asp:Literal ID="AFTitle" runat="server" Text="<%$Resources:ContentManagement, SSTitle %>"></asp:Literal>
        </h1>
...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftPlaceHolder" runat="server">
    <jareeda:SectionsTotalControl runat="server" />
</asp:Content>
