...
{
	/// <summary>
	/// This is a Business Entity Class  for ConferenceSpeakersLanguage table
	/// </summary>

    [DataObject(true)]
	public class ConferenceSpeakersLanguage : Entity
	{
		public ConferenceSpeakersLanguage(){}
		...
		/// <summary>
		/// This Property represents the ConferenceSpeakerParentId which has int type
		/// </summary>
		private int _conferenceSpeakerParentId;
        [DataObjectField(false,false,false)]
		public int ConferenceSpeakerParentId
		{
            get 
            {
              return _conferenceSpeakerParentId;
            }
            set 
            {
                if (!RBMInitiatingEntity && _conferenceSpeakerParentId != value)
                     RBMDataChanged = true;
                _conferenceSpeakerParentId = value;
            }
		}
        ...
        public string SpeakerName
        {
            get 
            {
                if (string.IsNullOrEmpty(_SpeakerName))
                {
                    ...
                    Persons.PersonLanguages lang = CurrentPerson.GetByLanguageID(LanguageID);
                    if (lang == null) { _SpeakerName = CurrentPerson.DisplayName; return _SpeakerName; }
                    _SpeakerName = lang.DisplayName;
                }
                return _SpeakerName; 
            }
