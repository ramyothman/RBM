...
{
	/// <summary>
	/// This is a Business Entity Class  for ConferenceRegisterations table
	/// </summary>

    [DataObject(true)]
    [Serializable()]
	public class ConferenceRegisterations : Entity
	{
		public ConferenceRegisterations(){}
        ...
        public BusinessLogicLayer.Entities.Persons.Person CurrentPerson
        {
            ...
            get
            {
                ...
                {
                    _CurrentPerson = Common.PersonLogic.GetByID(PersonId);
                    if (_CurrentPerson == null)
                        _CurrentPerson = new BusinessLogicLayer.Entities.Persons.Person();
                }
        ...
        private BusinessLogicLayer.Entities.Conference.Conferences _CurrentConference = null;
        ...
        private string _UniquePayment;
        public string UniquePayment
        {
            get 
            {
                
                //018127003531CurrentConference.ab
                if (CurrentConference != null)
                    return string.Format("Q-{0}-{1}", CurrentConference.ConferenceId, ConferenceRegistererId);
                else
                    return "";
                return _UniquePayment; 
            }
        ...
        private BusinessLogicLayer.Entities.Conference.ConferenceRegistrationType _CurrentConferenceRegistrationType;
        public BusinessLogicLayer.Entities.Conference.ConferenceRegistrationType CurrentConferenceRegistrationType
        {
            get 
            {
                if (_CurrentConferenceRegistrationType == null)
                {
                    BusinessLogicLayer.Components.Conference.ConferenceRegistrationTypeLogic l = new Components.Conference.ConferenceRegistrationTypeLogic();
                    _CurrentConferenceRegistrationType = l.GetByID(_conferenceRegistrationTypeId);
                }
                return _CurrentConferenceRegistrationType; 
            }
            set { _CurrentConferenceRegistrationType = value; }
        }

		/// <summary>
		/// This Property represents the PreConferenceWorkShopIncluded which has nchar type
		/// </summary>
		private bool _preConferenceWorkShopIncluded = false;
