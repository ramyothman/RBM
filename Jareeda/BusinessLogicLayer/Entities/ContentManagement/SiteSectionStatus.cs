...
{
	/// <summary>
	/// This is a Business Entity Class  for SiteSectionStatus table
	/// </summary>

    [DataObject(true)]
	public class SiteSectionStatus : Entity
	{
		public SiteSectionStatus(){}

		/// <summary>
		/// This Property represents the SiteSectionStatusId which has int type
		/// </summary>
		private int _siteSectionStatusId;
        [DataObjectField(true,true,false)]
		public int SiteSectionStatusId
		{
            get 
            {
              return _siteSectionStatusId;
            }
            set 
            {
                if (!RBMInitiatingEntity && _siteSectionStatusId != value)
                     RBMDataChanged = true;
                _siteSectionStatusId = value;
            }
		}
