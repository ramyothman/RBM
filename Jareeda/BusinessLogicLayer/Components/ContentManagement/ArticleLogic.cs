...
namespace BusinessLogicLayer.Components.ContentManagement
{
	...
	public partial class ArticleLogic : BusinessLogic
	{
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
        public List<Article> GetAllNew(string SiteId, string SectionId, string TypeId)
        {
            ArticleDAC _articleComponent = new ArticleDAC();
            string whereCondition = "";
            if (!string.IsNullOrEmpty(SiteId) && SiteId != "0" && SiteId != "null")
            ...
            IDataReader reader = _articleComponent.GetAllArticleNew(whereCondition).CreateDataReader();
            List<Article> _articleList = new List<Article>();
            while (reader.Read())
            {
                if (_articleList == null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
        public List<Article> GetAllBySectionIdandCountExcludingCurrent(int ArticleID,string SiteSectionId, int ItemsNumber)
        {
            ArticleDAC _articleComponent = new ArticleDAC();
            string whereCondition = "";
            if (!string.IsNullOrEmpty(SiteSectionId) && SiteSectionId != "0")
            {
                whereCondition = "ArticleId <> " + ArticleID + " and SiteSectionId = " + SiteSectionId;
            }
            IDataReader reader = _articleComponent.GetAllArticleByCountandOrder(whereCondition, ItemsNumber).CreateDataReader();
            List<Article> _articleList = new List<Article>();
            while (reader.Read())
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
        public List<Article> GetTopReadArticles(int ItemsNumber)
        {
            ArticleDAC _articleComponent = new ArticleDAC();
            string whereCondition = "";
            DateTime oldDate = DateTime.Today.AddDays(-7);
            whereCondition = " PostDate Between '" + oldDate.Year + "-" + oldDate.Month + "-" + oldDate.Day + "' and '" + DateTime.Today.Year + "-" + DateTime.Today.Month + "-" + DateTime.Today.Day + "' ";
            IDataReader reader = _articleComponent.GetAllArticleByCount(whereCondition, ItemsNumber, " Order By ViewsCount desc ").CreateDataReader();
            List<Article> _articleList = new List<Article>();
            while (reader.Read())
            {
                if (_articleList == null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
        public List<Article> GetArticlesByID(string articles, int ItemsNumber)
        {
            ArticleDAC _articleComponent = new ArticleDAC();
            string whereCondition = "";
            DateTime oldDate = DateTime.Today.AddDays(-7);
            whereCondition = " ArticleID IN(" + articles  + ")";
            IDataReader reader = _articleComponent.GetAllArticleByCount(whereCondition, ItemsNumber, " ").CreateDataReader();
            List<Article> _articleList = new List<Article>();
            while (reader.Read())
            {
                if (_articleList == null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
        public Article FindLastArticle(string LanguageID, string SiteID)
        {
            ArticleDAC _articleComponent = new ArticleDAC();
            string whereCondition = "";

            IDataReader reader = _articleComponent.FindLastArticles(LanguageID, SiteID);
            Article _article = new Article();
            while (reader.Read())
            {
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
        public int GetTotalArticles(int SiteID,DateTime date)
        {
            ArticleDAC _articleComponent = new ArticleDAC();
            IDataReader reader = _articleComponent.GetTotalArticlesByDate(SiteID,date);
            List<Article> _articleList = new List<Article>();
            int result = 0;
            while (reader.Read())
            {
        ...
        [DataObjectMethod(DataObjectMethodType.Select)]
        public int GetTotalArticles(DateTime date)
        {
            return GetTotalArticles(0, date);
        }

        [DataObjectMethod(DataObjectMethodType.Select)]
        public int GetTotalArticles(int SiteID)
        {
            return GetTotalArticles(SiteID, DateTime.MinValue);
        }

        [DataObjectMethod(DataObjectMethodType.Select)]
        public int GetTotalArticles()
        {
            return GetTotalArticles(0, DateTime.MinValue);
        }
        [DataObjectMethod(DataObjectMethodType.Select)]
