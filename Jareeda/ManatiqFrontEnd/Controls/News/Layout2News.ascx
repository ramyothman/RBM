<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Layout2News.ascx.cs" Inherits="ManatiqFrontEnd.Controls.News.Layout2News" %>
<div class="block-3  block-dis-mob">
